...
<head>
    ...
    <title>Contact Us - Household Packers</title>
...
<body>
    ...
    <section class="page-banner" style="background: linear-gradient(135deg, var(--primary-color) 0%, var(--secondary-color) 100%); padding: 80px 0 40px; text-align: center; color: white;">
        <div class="container">
            <h1 style="font-size: 2.5rem; font-weight: 800; margin-bottom: 10px;">Contact Us</h1>
            <p style="font-size: 1.1rem; opacity: 0.9;">Get in touch with us for household relocation and home shifting services.</p>
        </div>
    </section>

            ...
            <ul class="nav-links">
                ...
                <li class="dropdown">
                    ...
                    <div class="dropdown-content">
                        <a href="house-shifting.php">HOUSE SHIFTING</a>
                        <a href="office-relocation.php">OFFICE RELOCATION</a>
                        <a href="car-transportation.php">CAR TRANSPORTATION</a>
                        <a href="bike-transportation.php">BIKE TRANSPORTATION</a>
                        <a href="furniture-shifting.php">FURNITURE SHIFTING</a>
                        <a href="packers-and-movers.php">PACKERS AND MOVERS</a>
                    </div>
                </li>
                <li><a href="join-as-vendor.php">JOIN AS VENDOR</a></li>
                <li class="dropdown">
